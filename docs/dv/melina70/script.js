...
function Start() {
    // Removed function to remove Whatsapp Share: Since 2016 Whatsapp Web has been introduced
    // Generalized background
    player = new Gapless5("background", {
        tracks: [document.querySelector("source").src],
        loop: true,
        playOnLoad: true
    });
    ...
    console.log("%cMelina 70 - Sabato 20 Novembre 2021", "color:black;font-size:2em;font-weight:lighter;font-family:NinoFont, Arial, sans-serif;opacity:0.7");
    ...
    if(isIE()) {
        document.getElementById("footer-container").innerHTML = '<div id="share-container" onclick="OpenShareMenu()"><img src="share.svg"><div id="s-text">condividi</div></div><div id="share-menu" onclick="CloseShareMenu()"><a title="Condividi su Facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A//www.alessiogiordano.net/dv/melina70/"><div class="sm-choice"><img src="facebook.svg" /><div>Facebook</div></div></a><a title="Condividi su Twitter" target="_blank" href="https://twitter.com/home?status=Guarda%20Melina%2070%20%20da%20questo%20link%3A%20https%3A//www.alessiogiordano.net/dv/melina70/"><div class="sm-choice"><img src="twitter.svg" /><div>Twitter</div></div></a><a title="Condividi su Whatsapp" target="_blank" href="whatsapp://send?text=Guarda Melina 70 da questo link: https://www.alessiogiordano.net/dv/melina70/" data-action="share/whatsapp/share"><div class="sm-choice"><img src="whatsapp.svg" /><div>Whatsapp</div></div></a><a title="Condividi via Mail" id="shareNewsA" href="mailto:?&amp;subject=Guarda Melina 70&amp;body=Guarda Melina 70 da questo link: https://www.alessiogiordano.net/dv/melina70/"><div class="sm-choice"><img src="mail.svg" /><div>Mail</div></div></a></div><a title="Sviluppato con tecnologia ilmovnino.tk DV" target="_blank" href="https://www.alessiogiordano.net/"><div id="logo">© 2021 Alessio Giordano</div></a>';
...
function Download(url) {
    ...
    if("download" in document.createElement("a")) {
        document.getElementById("a").href = src;
...
function iOSaudio() {
    // Removed DetectiOS() evaluation as all browsers have copied Safari since 2016 in blocking audio not started by user interaction
    if(true) { player.stop(); $("#h-volume1").css("background-image", "url('volume-off.svg')"); $("#h-volume2").css("background-image", "url('volume-off.svg')"); };
};
function OpenShareMenu() {
    if ('share' in navigator) {
        navigator.share({title: "Melina 70", text: "Guarda Melina 70 da questo link: https://www.alessiogiordano.net/dv/melina70/", link: "https://www.alessiogiordano.net/dv/melina70/"});
    } else {
        if(!menuOpened) {
